...
var itemUsedDistribution = new Array(60).fill(0);
...
console.log("Average item needed: " + averageItem + ";Median item needed: " + medianItem) 


function isCurrentSlots4Same(){
    if (currentSlots.length < 4){
        return false
    }
    var b = true
